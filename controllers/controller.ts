...
function createRocket(){
    ...
    if(checkRocketName(name)){
        ...
        (<HTMLInputElement>document.getElementById("rocketsCreated")).innerHTML = "You have created " + rockets.length + " rockets. <br>";
...
function findRocket(RocketToFind1 ?: string, RockerToFind2 ?: string) {
